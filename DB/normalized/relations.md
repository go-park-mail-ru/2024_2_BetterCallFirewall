...
## Функциональные зависимости
{id} -> {file, post_id, comment_id, profile_id, created_at}
## Нормальная форма
Таблица, очевидно, находится в первой нормальной форме, так как все атрибуты являются простыми и записи в таблице не повторяются.
...
## Функциональные зависимости
{id} -> {receiver, sender, content, created_at, updated_at}
## Нормальная форма
Таблица, очевидно, находится в первой нормальной форме, так как все атрибуты являются простыми и записи в таблице не повторяются.
...
# Таблица like
## Описание таблицы
Таблица like содержит лайки пользователей на посты, комментарии и файлы.
## Функциональные зависимости
