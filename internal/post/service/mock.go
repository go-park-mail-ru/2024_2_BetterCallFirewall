...
func (mr *MockDBMockRecorder) CheckLikes(ctx, postID, userID interface{}) *gomock.Call {
...
func (mr *MockDBMockRecorder) Create(ctx, post interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) CreateCommunityPost(ctx, post, communityID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) Delete(ctx, postID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) DeleteLikeFromPost(ctx, postID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) Get(ctx, postID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) GetCommunityPosts(ctx, communityID, lastID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) GetFriendsPosts(ctx, friendsID, lastID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) GetLikesOnPost(ctx, postID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) GetPostAuthor(ctx, postID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) GetPosts(ctx, lastID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) SetLikeToPost(ctx, postID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) Update(ctx, post interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProfileRepoMockRecorder) GetFriendsID(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProfileRepoMockRecorder) GetHeader(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCommunityRepoMockRecorder) CheckAccess(ctx, communityID, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetHeader indicates an expected call of GetHeader.
func (mr *MockCommunityRepoMockRecorder) GetHeader(ctx, communityID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
